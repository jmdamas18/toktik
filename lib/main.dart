...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VideoPostRepository videoPostRepository = VideoPostRepositoryImpl(videoPostDataSource: LocalVideoPostDatasourceImpl());

    return MultiProvider(
      providers: [ChangeNotifierProvider(create: (_) => DiscoverProvider(videoPostRepository: videoPostRepository)..loadNextPage())],
      child: MaterialApp(
        title: 'TokTik',
